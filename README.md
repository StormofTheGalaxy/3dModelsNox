...
Приёмка фазы (ТЗ §7): ТЗ создаётся с ИИ за минуты, шарится ссылкой гостю,
экспортируется в PDF; кредиты списываются и видны. Проверено сквозным
браузерным сценарием из 30 шагов.

Следующая фаза — витрина заказов и отклики (ТЗ §7, фаза 3).
...
[`docs/adr/0003-phase-2.md`](docs/adr/0003-phase-2.md).
