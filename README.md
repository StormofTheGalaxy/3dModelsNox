...
## Статус: фаза 3 — витрина и отклики
...
Следующая фаза — сделки: этапы, чеки, сдачи, споры и чат (ТЗ §7, фаза 4).
...
| BriefChangeRequest | Модель заведена; UI появится вместе со сделками в фазе 4 |
...
[`docs/adr/0004-phase-3.md`](docs/adr/0004-phase-3.md).
